...
export default function Home(){
  return(
    <div className='flex flex-col items-center justify-center min-h-screen p-4'>
        ...
        <article className='flex w-full align-center justify-center items-center pt-15 pb-15 pl-40 pr-40 mb-7 gap-150 shadow-2xl border-t border-b border-blue-950 rounded-2xl hover:border-blue-800 hover:scale-103 hover:transition-all duration-400'>
        ...
        <article className='flex w-full align-center justify-center items-center pt-15 pb-15 pl-40 pr-40 mb-7 gap-150 shadow-2xl border-t border-b border-blue-950 rounded-2xl hover:border-blue-800 hover:scale-103 hover:transition-all duration-400'>
          ...
          <span className='flex flex-col text-2xl items-center justify-center gap-5 pl-5'>
            ...
            <Link href="/vagas" className='flex items-center align-center font-bold justify-center text-gray-300 text-nowrap hover:text-gray-500 transition-colors duration-400'>Clique aqui pra cadastrar suas vagas.</Link>
          </span>
        </article>
